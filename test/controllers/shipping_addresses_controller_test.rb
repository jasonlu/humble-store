...
class ShippingAddressesControllerTest < ActionController::TestCase
  ...
  test "should create shipping_address" do
    assert_difference('ShippingAddress.count') do
      post :create, shipping_address: { address: @shipping_address.address, note: @shipping_address.note, phone: @shipping_address.phone, primary: @shipping_address.primary, user_id: @shipping_address.user_id, zip: @shipping_address.zip }
    end
  ...
  test "should update shipping_address" do
    patch :update, id: @shipping_address, shipping_address: { address: @shipping_address.address, note: @shipping_address.note, phone: @shipping_address.phone, primary: @shipping_address.primary, user_id: @shipping_address.user_id, zip: @shipping_address.zip }
    assert_redirected_to shipping_address_path(assigns(:shipping_address))
  end
